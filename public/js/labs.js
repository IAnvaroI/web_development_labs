...
//     }
//     if((surname.search(/[^A-Za-z]/g)) !== -1 || surname === "") {
//         e.preventDefault();
...
//     }
//     if((color.search(/ff0000/g)) !== -1) {
//         e.preventDefault();
//         alert("Color cannot be a red one.");
//     }
//     if(birthday.split('-')[0] < 1900 && birthday.split('-')[0] !== "") {
//         e.preventDefault();
//         alert("You birthday cannot be earlier than 1900.");
//     }
//     if((pass.length < 8 || pass.length > 20) && pass !== "") {
//         e.preventDefault();
//         alert("Pass can consist of 8-20 symbols.");
//     }
//     if(comment.length > 300 && comment !== "") {
//         e.preventDefault();
