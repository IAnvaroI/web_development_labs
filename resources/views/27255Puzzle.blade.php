...
@section('content')
    ...
    <div id="puzzle">
        ...
        <table>
            <tr>
                ...
                <td class="white"></td>
                <td class="black"></td>
                <td class="white"><img src="../images/knightW.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"><img src="../images/rookW.png" style="max-width:100%; max-height:100%;"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="black"><img src="../images/pawnW.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="white"></td>
                <td class="black"><img src="../images/bishopW.png" style="max-width:100%; max-height:100%;"/></td>
            </tr>
            <tr>
                <td class="black"></td>
                <td class="white"></td>
                <td class="black"><img src="../images/queenB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="white"><img src="../images/knightB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"></td>
                <td class="white"><img src="../images/queenW.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"></td>
                <td class="white"><img src="../images/pawnW.png" style="max-width:100%; max-height:100%;"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="black"></td>
                <td class="white"></td>
                <td class="black"><img src="../images/bishopB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="white"></td>
            </tr>
            <tr>
                <td class="white"><img src="../images/pawnB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"><img src="../images/pawnB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="white"><img src="../images/pawnB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"></td>
                <td class="white"></td>
                <td class="black"><img src="../images/pawnB.png" style="max-width:100%; max-height:100%;"/></td>
            ...
            <tr>
                <td class="black"></td>
                <td class="white"><img src="../images/kingB.png" style="max-width:100%; max-height:100%;"/></td>
                <td class="black"></td>
                <td class="white"></td>
                <td class="black"></td>
                <td class="white"></td>
    ...
    <div id="linksDiv">
        ...
        @php
            ...
            $puzzle = Puzzle::where(['puzzleId' => '27255'])->first();
    ...
    <div id="othersFunctions">
        ...
        <a href="{{route('27255histogram')}}"><button id="histogram" class="buttons">Histogram</button></a>
    </div>
@endsection
